...
public class AddPostCampusInformation extends AppCompatActivity {

    EditText mTitleEt, mDescrEt;
    ImageView mPostIv;
    Button mUploadBtn;

    String mStoragePath = "Campus_Information/";
    String mDatabasePath = "CampusInformationData";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_post_campus_information);
        ...
        mProgressDialog = new ProgressDialog(AddPostCampusInformation.this);
    }
    ...
    private void deletePreviousImage() {
        ...
        mPictureRef.delete().addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void aVoid) {
                Toast.makeText(AddPostCampusInformation.this,"Previous image deleted...",Toast.LENGTH_SHORT).show();
                uploadNewImage();
            }
        })
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(AddPostCampusInformation.this,e.getMessage(),Toast.LENGTH_SHORT).show();
    ...
    private void uploadNewImage() {
        ...
        uploadTask.addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                Toast.makeText(AddPostCampusInformation.this,"New image Uploaded...",Toast.LENGTH_SHORT).show();
    ...
    private void updateDatabase(final String s) {
        ...
        DatabaseReference mRef = mFirebaseDatabase.getReference("CampusInformationData");
        ...
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                mProgressDialog.dismiss();
                Toast.makeText(AddPostCampusInformation.this,"Database updated...",Toast.LENGTH_SHORT).show();
                startActivity(new Intent(AddPostCampusInformation.this,CampusInformation.class));
                finish();
            }
            ...
            storageReference2nd.putFile(mFilePathUri)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            mProgressDialog.dismiss();
                            Toast.makeText(AddPostCampusInformation.this,"Uploaded Successfully...",Toast.LENGTH_SHORT).show();
