...
public class AddPostJobs extends AppCompatActivity {

    EditText mTitleEt, mDescrEt;
    ImageView mPostIv;
    Button mUploadBtn;

    String mStoragePath = "Jobs/";
    String mDatabasePath = "Jobs";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_post_jobs);
        ...
        mProgressDialog = new ProgressDialog(AddPostJobs.this);
    }
    ...
    private void deletePreviousImage() {
        ...
        mPictureRef.delete().addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void aVoid) {
                Toast.makeText(AddPostJobs.this,"Previous image deleted...",Toast.LENGTH_SHORT).show();
                uploadNewImage();
            }
        })
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(AddPostJobs.this,e.getMessage(),Toast.LENGTH_SHORT).show();
    ...
    private void uploadNewImage() {
        ...
        uploadTask.addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                Toast.makeText(AddPostJobs.this,"New image Uploaded...",Toast.LENGTH_SHORT).show();
    ...
    private void updateDatabase(final String s) {
        ...
        DatabaseReference mRef = mFirebaseDatabase.getReference("Jobs");
        ...
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                mProgressDialog.dismiss();
                Toast.makeText(AddPostJobs.this,"Database updated...",Toast.LENGTH_SHORT).show();
                startActivity(new Intent(AddPostJobs.this,Jobs.class));
                finish();
            }
            ...
            storageReference2nd.putFile(mFilePathUri)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            mProgressDialog.dismiss();
                            Toast.makeText(AddPostJobs.this,"Uploaded Successfully...",Toast.LENGTH_SHORT).show();
