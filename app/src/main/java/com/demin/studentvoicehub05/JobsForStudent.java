...
public class JobsForStudent extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jobs_for_student);

        ActionBar actionBar = getSupportActionBar();
        actionBar.setTitle("Jobs Services");
        ...
        mRef = mFirebaseDatabase.getReference("Jobs");
        showData();
    }

    private void showDeleteDataDialog(final String currentTitle, final String currentImage) {
        AlertDialog.Builder builder = new AlertDialog.Builder(JobsForStudent.this);
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                mQuery.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        Toast.makeText(JobsForStudent.this,"Post deleted successfully...",Toast.LENGTH_SHORT).show();
                    }

                    @Override
                    public void onCancelled(@NonNull DatabaseError databaseError) {
                        Toast.makeText(JobsForStudent.this,databaseError.getMessage(),Toast.LENGTH_SHORT).show();
                    }
                });
                ...
                mPictureRefe.delete().addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        Toast.makeText(JobsForStudent.this,"Image deleted successfully...",Toast.LENGTH_SHORT).show();
                    }
                }).addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(JobsForStudent.this,e.getMessage(),Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
            ...
            public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, final int i) {
                ...
                viewHolder.setOnClickListener(new ViewHolder.ClickListener() {
                    ...
                    public void onItemClick(View view, int position) {
                        ...
                        Intent intent = new Intent(view.getContext(), PostJobs.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.menuforstudent,menu);
