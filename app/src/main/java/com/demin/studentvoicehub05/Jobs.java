...
public class Jobs extends AppCompatActivity {
    ...
    private void showDeleteDataDialog(final String currentTitle, final String currentImage) {
        AlertDialog.Builder builder = new AlertDialog.Builder(Jobs.this);
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                mQuery.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        Toast.makeText(Jobs.this,"Post deleted successfully...",Toast.LENGTH_SHORT).show();
                    }

                    @Override
                    public void onCancelled(@NonNull DatabaseError databaseError) {
                        Toast.makeText(Jobs.this,databaseError.getMessage(),Toast.LENGTH_SHORT).show();
                    }
                });
                ...
                mPictureRefe.delete().addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        Toast.makeText(Jobs.this,"Image deleted successfully...",Toast.LENGTH_SHORT).show();
                    }
                }).addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(Jobs.this,e.getMessage(),Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
                ...
                viewHolder.setOnClickListener(new ViewHolder.ClickListener() {
                    ...
                    public void onItemLongClick(View view, int position) {
                        ...
                        builder.setItems(options, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                if(which == 0){
                                    Intent intent = new Intent(Jobs.this,AddPostJobs.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(id == R.id.action_add){
            startActivity(new Intent(Jobs.this,AddPostJobs.class));
            return true;
        }
