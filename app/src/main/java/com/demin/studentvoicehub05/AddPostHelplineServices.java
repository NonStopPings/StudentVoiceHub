...
public class AddPostHelplineServices extends AppCompatActivity {

    EditText mTitleEt, mDescrEt;
    ImageView mPostIv;
    Button mUploadBtn;

    String mStoragePath = "Helpline_Services_image/";
    String mDatabasePath = "Helpline_Services";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_post_helpline_services);
        ...
        mProgressDialog = new ProgressDialog(AddPostHelplineServices.this);
    }
    ...
    private void deletePreviousImage() {
        ...
        mPictureRef.delete().addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void aVoid) {
                Toast.makeText(AddPostHelplineServices.this,"Previous image deleted...",Toast.LENGTH_SHORT).show();
                uploadNewImage();
            }
        })
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(AddPostHelplineServices.this,e.getMessage(),Toast.LENGTH_SHORT).show();
    ...
    private void uploadNewImage() {
        ...
        uploadTask.addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                Toast.makeText(AddPostHelplineServices.this,"New image Uploaded...",Toast.LENGTH_SHORT).show();
    ...
    private void updateDatabase(final String s) {
        ...
        DatabaseReference mRef = mFirebaseDatabase.getReference("Helpline_Services");
        ...
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                mProgressDialog.dismiss();
                Toast.makeText(AddPostHelplineServices.this,"Database updated...",Toast.LENGTH_SHORT).show();
                startActivity(new Intent(AddPostHelplineServices.this,HelplineServices.class));
                finish();
            }
            ...
            storageReference2nd.putFile(mFilePathUri)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            mProgressDialog.dismiss();
                            Toast.makeText(AddPostHelplineServices.this,"Uploaded Successfully...",Toast.LENGTH_SHORT).show();
