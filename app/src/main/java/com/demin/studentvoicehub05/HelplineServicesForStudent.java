...
public class HelplineServicesForStudent extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_helpline_services_for_student);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(id == R.id.action_add){
            startActivity(new Intent(HelplineServicesForStudent.this,AddPostHelplineServices.class));
            return true;
        }
