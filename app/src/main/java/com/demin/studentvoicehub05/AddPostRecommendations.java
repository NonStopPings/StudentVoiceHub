...
public class AddPostRecommendations extends AppCompatActivity {

    EditText mTitleEt, mDescrEt;
    ImageView mPostIv;
    Button mUploadBtn;

    String mStoragePath = "Recommendations_image/";
    String mDatabasePath = "Recommendations";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_post_recommendations);
        ...
        mProgressDialog = new ProgressDialog(AddPostRecommendations.this);
    }
    ...
    private void deletePreviousImage() {
        ...
        mPictureRef.delete().addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void aVoid) {
                Toast.makeText(AddPostRecommendations.this,"Previous image deleted...",Toast.LENGTH_SHORT).show();
                uploadNewImage();
            }
        })
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(AddPostRecommendations.this,e.getMessage(),Toast.LENGTH_SHORT).show();
    ...
    private void uploadNewImage() {
        ...
        uploadTask.addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                Toast.makeText(AddPostRecommendations.this,"New image Uploaded...",Toast.LENGTH_SHORT).show();
    ...
    private void updateDatabase(final String s) {
        ...
        DatabaseReference mRef = mFirebaseDatabase.getReference("Recommendations");
        ...
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                mProgressDialog.dismiss();
                Toast.makeText(AddPostRecommendations.this,"Database updated...",Toast.LENGTH_SHORT).show();
                startActivity(new Intent(AddPostRecommendations.this,Recommendations.class));
                finish();
            }
            ...
            storageReference2nd.putFile(mFilePathUri)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            mProgressDialog.dismiss();
                            Toast.makeText(AddPostRecommendations.this,"Uploaded Successfully...",Toast.LENGTH_SHORT).show();
