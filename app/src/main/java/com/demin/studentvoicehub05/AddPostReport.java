...
public class AddPostReport extends AppCompatActivity {

    EditText mTitleEt, mDescrEt;
    ImageView mPostIv;
    Button mUploadBtn;

    String mStoragePath = "Report_image/";
    String mDatabasePath = "Report";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_post_report);
        ...
        mProgressDialog = new ProgressDialog(AddPostReport.this);
    }
    ...
    private void deletePreviousImage() {
        ...
        mPictureRef.delete().addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void aVoid) {
                Toast.makeText(AddPostReport.this,"Previous image deleted...",Toast.LENGTH_SHORT).show();
                uploadNewImage();
            }
        })
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(AddPostReport.this,e.getMessage(),Toast.LENGTH_SHORT).show();
    ...
    private void uploadNewImage() {
        ...
        uploadTask.addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                Toast.makeText(AddPostReport.this,"New image Uploaded...",Toast.LENGTH_SHORT).show();
    ...
    private void updateDatabase(final String s) {
        ...
        DatabaseReference mRef = mFirebaseDatabase.getReference("Report");
        ...
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                mProgressDialog.dismiss();
                Toast.makeText(AddPostReport.this,"Database updated...",Toast.LENGTH_SHORT).show();
                startActivity(new Intent(AddPostReport.this,Events.class));
                finish();
            }
            ...
            storageReference2nd.putFile(mFilePathUri)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            mProgressDialog.dismiss();
                            Toast.makeText(AddPostReport.this,"Uploaded Successfully...",Toast.LENGTH_SHORT).show();
