...
public class StudentRecommendations extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_student_recommendations);

        ActionBar actionBar = getSupportActionBar();
        actionBar.setTitle("Tips n Ideas");

        CardView buyAndSell = (CardView) findViewById(R.id.buyAndSell);
        buyAndSell.setOnClickListener(CardbuyAndSellHandler);

        CardView recommendations = (CardView) findViewById(R.id.student_recommendations);
    ...
    View.OnClickListener CardbuyAndSellHandler = new View.OnClickListener() {
        public void onClick(View view) {
            Intent buyAndSell=new Intent(getBaseContext(),BuyAndSell.class).
    ...
    View.OnClickListener CardrecommendationsHandler = new View.OnClickListener() {
        public void onClick(View view) {
            Intent recommendations=new Intent(getBaseContext(),Recommendations.class).
                    putExtra(Intent.EXTRA_TEXT, "A message form MainActivity");
