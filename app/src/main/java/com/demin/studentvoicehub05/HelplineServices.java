...
public class HelplineServices extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_helpline_services);

        ActionBar actionBar = getSupportActionBar();
        actionBar.setTitle("Student Support");
        ...
        mRef = mFirebaseDatabase.getReference("Helpline_Services");
        showData();
    }

    private void showDeleteDataDialog(final String currentTitle, final String currentImage) {
        AlertDialog.Builder builder = new AlertDialog.Builder(HelplineServices.this);
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                mQuery.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        Toast.makeText(HelplineServices.this,"Post deleted successfully...",Toast.LENGTH_SHORT).show();
                    }

                    @Override
                    public void onCancelled(@NonNull DatabaseError databaseError) {
                        Toast.makeText(HelplineServices.this,databaseError.getMessage(),Toast.LENGTH_SHORT).show();
                    }
                });
                ...
                mPictureRefe.delete().addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        Toast.makeText(HelplineServices.this,"Image deleted successfully...",Toast.LENGTH_SHORT).show();
                    }
                }).addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(HelplineServices.this,e.getMessage(),Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
            ...
            public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, final int i) {
                ...
                viewHolder.setOnClickListener(new ViewHolder.ClickListener() {
                    ...
                    public void onItemClick(View view, int position) {
                        ...
                        Intent intent = new Intent(view.getContext(), PostHelplineServices.class);
                    ...
                    public void onItemLongClick(View view, int position) {
                        ...
                        builder.setItems(options, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                if(which == 0){
                                    Intent intent = new Intent(HelplineServices.this,AddPostHelplineServices.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(id == R.id.action_add){
            startActivity(new Intent(HelplineServices.this,AddPostHelplineServices.class));
            return true;
        }
