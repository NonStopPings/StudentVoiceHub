...
public class RecommendationsForStudent extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_recommendations_for_student);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(id == R.id.action_add){
            startActivity(new Intent(RecommendationsForStudent.this,AddPostRecommendations.class));
            return true;
        }
