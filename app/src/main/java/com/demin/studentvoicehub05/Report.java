...
public class Report extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRef = mFirebaseDatabase.getReference("Report");
        showData();
    }
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                mQuery.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        Toast.makeText(Report.this,"Post deleted successfully...",Toast.LENGTH_SHORT).show();
                    }
                ...
                mPictureRefe.delete().addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        Toast.makeText(Report.this,"Image deleted successfully...",Toast.LENGTH_SHORT).show();
                    }
            ...
            public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, final int i) {
                ...
                viewHolder.setOnClickListener(new ViewHolder.ClickListener() {
                    ...
                    public void onItemClick(View view, int position) {
                        ...
                        Intent intent = new Intent(view.getContext(), PostReport.class);
                    ...
                    public void onItemLongClick(View view, int position) {
                        ...
                        builder.setItems(options, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                if(which == 0){
                                    Intent intent = new Intent(Report.this,AddPostReport.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(id == R.id.action_add){
            startActivity(new Intent(Report.this,AddPostReport.class));
            return true;
        }
